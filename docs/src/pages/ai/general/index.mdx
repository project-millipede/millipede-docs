...
[ Communication Process (CP) ] – [ Preparation Process (PP) ] – [ Render Process
(RP) ]
...
Target Application -> [ Communication Process ] – [ Preparation Process (PP) ] –
-> [ Shared Render Process (SRP) ] <- – [ Custom Preparation Process (CPP) ] – [
Custom Communication Process (CCP) ] <- Project Millipede
...
Target Application -> [ Communication Process ] – [ Preparation Process (PP) ] –
[ Render Process (RP) ] -> Observation / Reaction <- [ Low-level UI Coordination
] -> Reaction / Observation <- [ Custom Render Process (CRP) ] – [ Custom
Preparation Process (CPP) ] – [ Custom Communication Process ] <- Project
Millipede
