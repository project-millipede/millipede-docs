...
components and infrastructures is a significant challenge. Digital systems,
regardless of the type of application and degree of utilization, are appealing
targets for a large number of actors.

## Attacking targets

Essential criteria whether a system is subject to a high or rather low attack
load.
