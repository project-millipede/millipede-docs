...
> The project's objective is outlined through an open book most people used in the analog age.

## Objective

> The inserted book page on the left side comprises contents which supplement or correct the original contents of the opposing book page.
